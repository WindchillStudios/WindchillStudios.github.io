...
function Circle() {
	this.s = {ttl:8000, xmax:0, ymax:50, rmax:10, rt:1, xdef:-500, ydef:(HEIGHT-100)*Math.random(), xdrift:30, ydrift: 50, random:true, blink:false};
	...
	this.move = function() {
		this.x += ((this.rt/this.hl)*this.dx)+50;
		this.y += ((this.rt/this.hl)*this.dy)+10;
